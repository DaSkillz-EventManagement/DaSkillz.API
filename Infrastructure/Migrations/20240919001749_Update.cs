    ...
    public partial class Update : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Advertisements", x => x.EventId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdvertisementsEventId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Events", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Events_Advertisements_AdvertisementsEventId",
                        column: x => x.AdvertisementsEventId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_AdvertisementsEventId",
                table: "Events",
                column: "AdvertisementsEventId");
