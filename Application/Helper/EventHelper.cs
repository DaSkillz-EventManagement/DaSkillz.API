...
namespace Application.Helper
{
    public static class EventHelper
    {
        public static string GenerateCacheKeyFilteredEvent(EventFilterObjectDto filter, int pageNo, int eachPage)
        {
            ...
            keyBuilder.Append($"getEv_Filtered_Page_{pageNo}_Size_{eachPage}");
        ...
        public static string GenerateEventParticipatedByUser(EventFilterObjectDto filter, Guid userId, int pageNo, int eachPage)
        {
            var keyBuilder = new StringBuilder();

            keyBuilder.Append($"getEv_ParticipatedByUser_{userId}_Page_{pageNo}_Size_{eachPage}");
        ...
        public static string GenerateCacheKeyByTag(GetEventByTagQuery request)
        {
            ...
            return $"getEv_by_tags_{tagIds}_page_{request.PageNo}_size_{request.ElementEachPage}";
        }
    }
}
