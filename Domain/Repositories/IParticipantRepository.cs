...
{
    Task<List<HourlyPartitipant>> GetParticipationByHourAsync(DateTime startDate, DateTime endDate);
    Task<List<DailyParticipation>> GetParticipationByDayAsync(DateTime startDate, DateTime endDate);
